        ...
        <form class="standard-form bp-simple-post-form"  method="post" action=""  enctype="multipart/form-data">
            ...
            <?php endif;?>
             ...
             <label for="bp_simple_post_title"><?php _e('Title:','bsfep');?>
                <input type="text" name="bp_simple_post_title"  value="<?php echo stripslashes($title);?>"/>
             </label>

             <label for="bp_simple_post_text" ><?php _e('Post:','bsfep');?>
                 <?php wp_editor( stripslashes($content), 'bp_simple_post_text' ); ?>
             </label>
            ...
            <?php if($this->show_comment_option):?>
                <div class="simple-post-comment-option">
                    ...
                    <label for="bp-simple-post-comment-status">
                        <input id="bp-simple-post-comment-status" name="bp_simple_post_comment_status" type="checkbox" value="open" <?php echo checked('open',$current_status);?> /> Allow comments
                    </label>
